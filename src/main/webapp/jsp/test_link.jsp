<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	String s = response.getHeader("msg");
	String msg = request.getParameter("msg");
	System.out.println("login页面返回消息：" + msg);
%>
			...
			<div class="tab-content">
				<div class="index-tab-navs">
					<div class="navs-slider">
						<a class="selected">注册</a> <a>登录</a>
					</div>
				</div>

				<div class="show" id="signin" data-za-module="SignInForm">
					<form method="post" id="sign-form-0" action="">
					...
					<form class="zu-side-login-box" id="sign-form-1" autocomplete="off"
						...
						<div class="group-inputs">
							<div class="name input-wrapper">
								<input type="text" name="fullname" id="fullname" aria-label="昵称"
									placeholder="昵称">
							</div>
							<div class="email input-wrapper">

								<input type="text" class="account" name="phone_num"
									id="phone_num" aria-label="手机号（仅支持中国大陆）"
									placeholder="手机号（仅支持中国大陆）">
							</div>
							<div class="input-wrapper">
								<input type="password" name="password" id="password"
									aria-label="密码" placeholder="密码（不少于 6 位）" autocomplete="off">
							</div>
							<div class="input-wrapper captcha-module" data-type="en">
						...
						<div>
							<br>
							<button class="sign-button submit" type="submit" type="submit">注册</button>
						</div>
					</form>
...
<script type="text/javascript"
	src="/shopdev/js/lib/jquery/jquery-3.1.1.js"></script>
...
<script type="text/javascript">
	...
	var tabs = document.getElementsByClassName('navs-slider')[0]
			.getElementsByTagName('a'), contents = document
